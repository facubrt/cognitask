...
def aplicarSecuenciaTerapia(self):
    ...
    img_path = self.sesion.ubicacion_img.replace(' ', '%20')
...
def aplicarSecuenciaCalibracion(self):
    ...
    if self.sesion.indice_tarea == 1:
        self.sesion.ubicacion_img = ubicaciones.INSTALL_DIR + "/calibracion/tarea 1"
        ...
        self.sesion.ubicacion_img = ubicaciones.INSTALL_DIR + "/calibracion/tarea 2"
        # esto es necesario para BCI2000, ya que permite conocer como se ordenaran las imagenes en la matriz
    ...
    ubicacion_img = self.sesion.ubicacion_img.replace(' ', '%20')
