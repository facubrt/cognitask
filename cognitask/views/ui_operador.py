...
class Ui_BCIOperador(object):
    ...
    def retranslateUi(self, BCIOperador):
        ...
        self.tipo_tarea_opciones.setItemText(0, _translate("BCIOperador", "Bloque A1"))
        self.tipo_tarea_opciones.setItemText(1, _translate("BCIOperador", "Bloque A2"))
        self.tipo_tarea_opciones.setItemText(2, _translate("BCIOperador", "Bloque B1"))
        self.tipo_tarea_opciones.setItemText(3, _translate("BCIOperador", "Bloque B2"))
        self.tipo_tarea_opciones.setItemText(4, _translate("BCIOperador", "Bloque C1"))
        self.tipo_tarea_opciones.setItemText(5, _translate("BCIOperador", "Bloque C2"))
